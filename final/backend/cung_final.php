...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLGhFk5m-1IGHOHb02jvRBSJIZZfrlDic&libraries=places&callback=initMap" defer></script>
            ...
            <div class="modal-body">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li><a><input value="motel" type="checkbox"/>Motels</a></li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        <p>Attractions</p>
                        <li><a><input value="amusement park" type="checkbox"/>Amusement Parks</a></li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li><a><input value="wineries/Breweries" type="checkbox"/>Wineries, Breweries and
                                Distilleries</a></li>
                    </ul>
                </div>
            </div>
...
<div id="myModal2" class="modal fade" role="dialog" >
    <div class="modal-dialog">
        ...
        <div class="modal-content" id="modal_content">
            ...
            <div class="modal-footer">
                <button id="submit_event"  type="button" class="btn btn-default" data-dismiss="modal">Show Results</button>
            </div>
        </div>
    </div>
</div>
